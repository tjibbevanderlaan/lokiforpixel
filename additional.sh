...
sudo cp Sublime-Text-3-Arc-Dark-theme/Arc-Dark ~/.config/sublime-text-3/Packages/User/
sudo cp Sublime-Text-3-Arc-Dark-theme/Widget.sublime-settings ~/.config/sublime-text-3/Packages/User/
sudo cp papreferences/sublime/Arc-Monokai.tmTheme ~/.config/sublime-text-3/Packages/User/Arc-Dark/schemes/
