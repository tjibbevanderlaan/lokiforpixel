...
sudo apt-get install build-essential libjsoncpp-dev libglib2.0-dev # build essentials
...
sudo apt-get remove build-essential libjsoncpp-dev libglib2.0-dev # remove build essentials
